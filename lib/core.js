define(['lib/natives/math.js', 'lib/natives/array.js', 'lib/natives/number.js', 'lib/natives/string.js'], function() {
  var isBrowser, method, root, toString, _i, _len, _ref, _ref2;
  ...
  root.extend = function(object, mixin, overwrite) {
    var k, v;
    if (overwrite == null) {
      overwrite = true;
    }
