...
require(['client/game', 'screen', 'camera', 'canvas', 'colour', 'geometry/polygon', 'geometry/circle', 'collision/sat', 'collision/aabb', 'dynamics/world', 'game/entities/blob', 'game/entities/wall', 'game/entities/portal', 'game/entities/powerup'], function(Game, Screen, Camera, Canvas, Colour, Polygon, Circle, SAT, AABB, World, Blob, Wall, Portal, Powerup) {
  var $H, $W, $hH, $hW, GameScreen, Matrix, Vector, boundaries, canvas, coe, cof, game, i, player1, player2, powerup, powerups, rand, wall, walls, world, _i, _j, _len, _len2;
