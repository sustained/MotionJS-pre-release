...
require(['client/game', 'entity', 'camera', 'canvas', 'colour', 'math/vector', 'geometry/polygon', 'geometry/circle', 'collision/SAT', 'dynamics/world', 'screen'], function(Game, Entity, Camera, Canvas, Colour, Vector, Polygon, Circle, SAT, World, Screen) {
