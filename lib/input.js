...
input = function(Vector, Eventful) {
  ...
  Input = (function() {
    ...
    Input.prototype._onMouseMove = function(e) {
      if (e.timeStamp - this.lastMUpdate > 25) {
        this.lastMUpdate = e.timeStamp;
        return this.mouse.position.page.set(e.pageX, e.pageY);
      }
    };
    ...
    Input.prototype.update = function(camera) {
      return this.mouse.position.game = Vector.add(camera.position, this.mouse.position.page);
    };
    function Input(Game) {
      var char, code, _ref;
      this.Game = Game;
    ...
    Input.prototype.setup = function($el) {
      var $doc;
      $doc = $(document);
      $doc.keyup(this._onKeyUp.bind(this));
      $doc.keydown(this._onKeyDown.bind(this));
      $el.mouseup(this._onMouseUp.bind(this));
      $el.mousedown(this._onMouseDown.bind(this));
      return $el.mousemove(this._onMouseMove.bind(this));
    };
    return Input;
  })();
  _ref = Input.CHARMAP;
