...
define(['core', 'classutils'], function(Core, ClassUtils) {
  var BaseClass;
  BaseClass = (function() {
    var classId;
    classId = 0;
    ...
    BaseClass.extend = function(object, overwrite) {
      ...
      return extend(this, object, overwrite);
    };
    BaseClass.include = function(object, overwrite) {
      if (overwrite == null) {
        overwrite = false;
      }
      return extend(this.prototype, object, overwrite);
    };
    BaseClass.extend(ClassUtils.Ext.Accessors);
    BaseClass.prototype.bind = function() {
      var args, name, _ref;
      name = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      return this[name] = (_ref = this[name]).bind.apply(_ref, [this].concat(__slice.call(args)));
    };
