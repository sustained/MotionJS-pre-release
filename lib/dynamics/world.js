define(['collision/sat'], function(SAT) {
  ...
  World = (function() {
    ...
    World.prototype.getEntityById = function(id) {
      var _ref;
      return (_ref = this.entities[id]) != null ? _ref : false;
    };
    World.prototype.getEntitiesByType = function(type) {
      return this.types[type];
    };
    World.prototype.getEntitiesByClass = function(klass) {
      return this.classes[klass];
    };
    World.prototype.addEntity = function(entity) {
      var bodyType, klass, type;
      ...
      if (!this.classes[klass]) {
        this.classes[klass] = [];
      }
      this.types[type].push(entity);
      this.classes[klass].push(entity);
      bodyType = entity.body.static ? 'static' : 'dynamic';
      this.bodies[bodyType][entity.id] = entity.body;
      return this.entities[entity.id] = entity;
    };
    World.prototype.queryAabbIntersects = function(aabb, exclude) {
      var entity, id, intersects, _ref;
      if (exclude == null) {
        exclude = [];
      }
      intersects = [];
    ...
    World.prototype.queryAabbContains = function(aabb, exclude) {
      var contains, entity, id, _ref;
      if (exclude == null) {
        exclude = [];
      }
      contains = [];
