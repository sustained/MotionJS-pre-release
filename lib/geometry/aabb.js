...
define(['classutils', 'math/vector'], function(ClassUtils, Vector) {
  ...
  AABB = (function() {
    ...
    /*
    		...
    		*/
    AABB.prototype.setEdges = function(edges) {
      this.extents = edges;
      this.hw = (this.w = this.extents.l + this.extents.r) / 2;
      return this.hh = (this.h = this.extents.t + this.extents.b) / 2;
    };
    /*
    		#	Set the extents by passing in a width and a height.
    		*/
    AABB.prototype.setSizes = function(width, height) {
      this.hw = (this.w = width) / 2;
      this.hh = (this.h = height) / 2;
      return this.extents = {
        t: -this.hh,
        b: this.hh,
        l: -this.hw,
