...
define(['client/game', 'dynamics/world', 'geometry/circle', 'geometry/polygon', 'collision/aabb', 'screen', 'entity', 'camera', 'colour', 'animation/animation', 'animation/easing'], function(Game, World, Circle, Polygon, AABB, Screen, Entity, Camera, Colour, Animation, Easing) {
  var Bar, Foo, GameScreen, Vector, game, i, player1, player2, rand, _ref;
  game = new Game;
  Vector = Math.Vector, rand = Math.rand;
