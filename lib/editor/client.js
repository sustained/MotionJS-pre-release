...
require(['client/game', 'entity', 'camera', 'canvas', 'colour', 'math/vector', 'geometry/polygon', 'geometry/circle', 'collision/SAT', 'dynamics/world', 'collision/aabb', 'screen'], function(Game, Entity, Camera, Canvas, Colour, Vector, Polygon, Circle, SAT, World, AABB, Screen) {
