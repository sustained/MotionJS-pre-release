define(function() {
  ...
  Canvas = (function() {
    ...
    Canvas.prototype.fill = false;
    Canvas.prototype.stroke = false;
    ...
    Canvas.prototype.polygon = function(vertices, style) {
      var vertex, _i, _len;
      this.context.beginPath();
      this.context.moveTo(vertices[0].i, vertices[0].j);
      for (_i = 0, _len = vertices.length; _i < _len; _i++) {
        vertex = vertices[_i];
        this.context.lineTo(vertex.i, vertex.j);
      }
      this.context.lineTo(vertices[0].i, vertices[0].j);
      this.context.closePath();
      return this.draw(style);
    };
